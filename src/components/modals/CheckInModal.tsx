      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            <button 
              onClick={onCancel}
              className="w-full mt-6 py-4 sm:py-6 text-red-500 dark:text-red-400 font-black text-sm sm:text-lg hover:text-red-700 bg-red-50 dark:bg-red-900/20 rounded-xl sm:rounded-2xl border border-red-100 dark:border-red-900/30 transition-all outline-none font-bold"
            >
