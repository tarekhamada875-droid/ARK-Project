...
exports.verifyAdminPinForLogout = exports.checkPinAvailability = exports.authenticateUser = exports.validateVehicleOnCreate = exports.validateRechargeRequestOnUpdate = exports.validateRechargeRequestOnCreate = exports.validateGarageOnCreate = void 0;
...
// ============================================
exports.validateGarageOnCreate = functions.firestore
...
// ============================================
exports.validateRechargeRequestOnCreate = functions.firestore
    ...
    if (!data.durationDays || data.durationDays <= 0) {
        ...
        let days = 30;
        if (pkgName.includes('أسبوع') || pkgName.includes('7'))
            days = 7;
        else if (pkgName.includes('15') || pkgName.includes('نصف'))
            days = 15;
        else if (pkgName.includes('30') || pkgName.includes('شهر'))
            days = 30;
...
// ============================================
exports.validateRechargeRequestOnUpdate = functions.firestore
    .document('recharge_requests/{requestId}')
...
// ============================================
exports.validateVehicleOnCreate = functions.firestore
...
// ============================================
exports.verifyAdminPinForLogout = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        return { valid: false };
    }
